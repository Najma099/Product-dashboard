...
export const Footer = () => {
  ...
  return (
    <footer className="bg-gradient-to-r from-card/40 to-card/20 backdrop-blur-sm border-t border-border/50 mt-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8">
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <p className="text-muted-foreground text-sm leading-relaxed max-w-sm">
              Empowering businesses with comprehensive product transparency solutions. 
              Build trust through verified certifications and detailed supply chain visibility.
            </p>
            <div className="flex space-x-4">
              {socialLinks.map((social) => (
                <a
                  key={social.name}
                  href={social.href}
                  className="w-10 h-10 bg-secondary hover:bg-secondary/80 rounded-lg flex items-center justify-center text-secondary-foreground hover:text-primary transition-all duration-200 hover:shadow-lg hover:shadow-primary/25"
        ...
        <div className="mt-12 pt-8 border-t border-border/30">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="flex items-center space-x-2 text-sm text-muted-foreground">
              <span>© {currentYear} TransparencyHub.</span>
