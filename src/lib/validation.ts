export const validateStep = (step: number, data: any) => {
  ...
  switch (step) {
    case 1:
      ...
      break;
    case 2:
      if (!data.ingredients?.length) errors.ingredients = 'At least one ingredient is required';
      ...
      break;
    case 3:
      if (!data.certification || data.certification === 'None') errors.certification = 'Please select a certification level';
